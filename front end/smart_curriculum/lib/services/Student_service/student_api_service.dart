...
class ApiService {
  ...
  static Future<void> saveLoginState() async {
    try {
      ...
      Logger.error('saveLoginState error: $e');
    }
  }
  ...
  static Future<void> loadLoginState() async {
    try {
      ...
      Logger.error('loadLoginState error: $e');
    }
  }
  ...
  static Future<void> clearLoginState() async {
    ...
    try {
      ...
      Logger.error('clearLoginState error: $e');
    }
  }
  ...
  static Future<Map<String, dynamic>?> _post(
    ...
    try {
      final res =
          await http.post(uri, body: body).timeout(timeout ?? _httpTimeout);
      return _handleResponse(res);
    } on TimeoutException {
      Logger.error("POST timeout: ${uri.toString()}");
      return {"_error": "timeout"};
    } catch (e) {
      Logger.error("POST error: ${uri.toString()} -> $e");
  ...
  static Future<Map<String, dynamic>?> _get(
    ...
    try {
      ...
      Logger.error("GET timeout: ${uri.toString()}");
      return {"_error": "timeout"};
    } catch (e) {
      Logger.error("GET error: ${uri.toString()} -> $e");
      return {"_error": e.toString()};
    }
  }
  ...
  static Map<String, dynamic>? _handleResponse(http.Response res) {
    try {
      ...
      if (res.statusCode >= 200 && res.statusCode < 300) {
        ...
        Logger.error("HTTP error ${res.statusCode}: ${res.body}");
  ...
  static Future<bool> studentLogin(String username, String password) async {
    ...
    try {
      ...
      Logger.info("Login response code: ${res.statusCode}");
      Logger.info("Login response body: ${res.body}");
      ...
      loggedInStudentName =
          data["name"] ?? data["studentName"] ?? data["fullName"];
      loggedInStudentId = parsedId;

      Logger.success("Student Login Successful");
      Logger.log("ID: $loggedInStudentId");
      Logger.log("Name: $loggedInStudentName");
      ...
      Logger.error("studentLogin timeout");
      return false;
    } catch (e) {
      Logger.error("studentLogin error: $e");
      return false;
    }
  }
  ...
  static Future<bool> checkFaceExists(String studentName) async {
    final uri = Uri.parse("${ApiService.faceUrl}/face/exists")
  ...
  static Future<Map<String, dynamic>?> getStudentProfile() async {
    if (loggedInStudentId != null) {
      ...
      try {
        ...
        Logger.error("getStudentProfile by id error: $e");
      }
    }
    ...
    final url = Uri.parse(
        "$springUrl/student/me?username=${Uri.encodeQueryComponent(loggedInUsername!)}");
    ...
    try {
      ...
      Logger.error("getStudentProfile timeout");
      return null;
    } catch (e) {
      Logger.error("getStudentProfile error: $e");
      return null;
    }
  }
  ...
  // ---------------------------------------------------------
  static Future<Map<String, dynamic>?> fetchFullProfileById(
      int studentId) async {
    final url = Uri.parse("$springUrl/profile/id/$studentId");
    ...
    try {
      ...
      Logger.error("fetchFullProfileById error: $e");
      return null;
    }
  }
  ...
  static Future<bool> updateFullProfile(
    ...
    final url =
        Uri.parse("$springUrl/profile/${Uri.encodeComponent(studentName)}");
    ...
    try {
      ...
      Logger.error("updateFullProfile failed: ${res.statusCode} ${res.body}");
      return false;
    } on TimeoutException {
      Logger.error("updateFullProfile timeout");
      return false;
    } catch (e) {
      Logger.error("updateFullProfile error: $e");
      return false;
    }
  }
  ...
  static Future<bool> markAttendance(String studentName) async {
    ...
    try {
      ...
      Logger.error("markAttendance timeout");
      return false;
    } catch (e) {
      Logger.error("markAttendance error: $e");
      return false;
    }
  }
  ...
  static Future<bool> markAbsent(String studentName) async {
    ...
    try {
      ...
      Logger.error("markAbsent timeout");
      return false;
    } catch (e) {
      Logger.error("markAbsent error: $e");
      return false;
    }
  }
  ...
  static Future<Map<String, dynamic>?> fetchProgress(int studentId) async {
    final res = await _get(aiBase, "/progress_roadmap",
  ...
  static Future<Map<String, dynamic>?> generateRoadmap(
      int studentId, String topic) async {
    ...
    try {
      ...
      Logger.error("generateRoadmap error: $e");
      return {"_error": e.toString()};
    }
  }
  ...
  static Future<Map<String, dynamic>?> openMiniSession(
      int miniSessionId) async {
    final uri =
        Uri.parse("$aiBase/open_mini_session").replace(queryParameters: {
    ...
    try {
      ...
      Logger.error("openMiniSession error: $e");
      return {"_error": e.toString()};
    }
  }
  ...
  static Future<Map<String, dynamic>?> getNextMiniSession(int studentId) async {
    final uri =
        Uri.parse("$aiBase/next_mini_session").replace(queryParameters: {
      "student_id": studentId.toString(),
    });
    ...
    try {
      ...
      Logger.error("getNextMiniSession error: $e");
      return {"_error": e.toString()};
    }
  }
  ...
  static Future<Map<String, dynamic>?> completeMiniSession({
    ...
    final answersJson = jsonEncode(
        {"answers": answersMap.map((k, v) => MapEntry(k.toString(), v))});
    ...
    try {
      ...
      Logger.error("completeMiniSession error: $e");
      return {"_error": e.toString()};
    }
  }
  ...
  static Future<String?> chatbot(String message) async {
    final res = await _post(aiBase, "/chatbot", {"message": message},
  ...
  static Future<List<dynamic>?> listStudents() async {
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (parsed is Map && parsed.containsKey("_list"))
          return parsed["_list"];
      }
    } catch (e) {
      Logger.error("listStudents error: $e");
    }
    return null;
  }
