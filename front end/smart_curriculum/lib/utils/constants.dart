...
class AppColors {
  ...
  static const secondaryColor = Color(0xFF0039CB);
...
class AppStrings {
  ...
  static const studentPerformance = 'Student Performance';
  static const postExamMarks = 'Post Exam Marks';
  static const summary = 'Summary';
  static const lowGrade = 'Low Grade';
  static const goodPerformance = 'Good Performance';
  static const poorPerformanceDetected = 'Poor Performance Detected';
  static const keepGoing = 'Keep Going!';
  static const createQuiz = 'Create Quiz';
  static const setQuizzes = 'Set Quizzes';
  static const startQuiz = 'Start Quiz';
  static const stopQuiz = 'Stop Quiz';
  static const quizTime = 'Time: 10 mins';
