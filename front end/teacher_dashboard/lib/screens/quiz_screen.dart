...
import 'package:teacher_dashboard/models/quiz_model.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Create Quiz Form (only shown when _showCreateForm is true and no active quiz)
            ...
            // Available quizzes (hidden when quiz is active)
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: const Icon(Icons.quiz, color: AppColors.primaryColor),
                        title: Text(quiz.title),
                        subtitle: Text('${quiz.duration} min • ${quiz.questions.length} Qs'),
